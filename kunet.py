...
print(sliced_image_dataset.shape)
print(sliced_mask_dataset.shape)
...
#     f = open('train-test.txt', 'a')
#     print('test_index: ', test_index, file=f)
#     print('testing set: ', name_test, file=f)
