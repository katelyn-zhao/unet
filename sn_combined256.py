...
for i, (train_index, test_index) in enumerate(kf.split(sliced_image_dataset, sliced_mask_dataset)):
    ...
    f = open("C:/Users/Mittal/Desktop/2Dsegnet_256/test_index.txt", "a")
    ...
    plt.xlabel('Epoch')
    plt.tight_layout()
    plt.savefig(f'C:/Users/Mittal/Desktop/2Dsegnet_256/process{i}.png')
    plt.close()
    ...
    f = open("C:/Users/Mittal/Desktop/2Dsegnet_256/output.txt", "a")
    ...
    model.load_weights(f'C:/Users/Mittal/Desktop/2Dsegnet_256/best_model{i}.h5')
    model.save(f'C:/Users/Mittal/Desktop/2Dsegnet_256/final_model{i}.h5')
    ...
    for z in range(10):
        ...
        plt.savefig(f'C:/Users/Mittal/Desktop/2Dsegnet_256/predict/fold{i}_{z}.png')
        plt.close()
