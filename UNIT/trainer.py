...
class MUNIT_Trainer(nn.Module):
    ...
    def compute_vgg_loss(self, vgg, img, target):
        ...
        img_fea = vgg.features(img_vgg)  # Ensure this returns a 4D tensor
        target_fea = vgg.features(target_vgg)  # Ensure this returns a 4D tensor

        img_fea = self.instancenorm(img_fea)
        target_fea = self.instancenorm(target_fea)
